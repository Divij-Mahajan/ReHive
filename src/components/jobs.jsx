...
function Jobs({role}) {
  ...
  return <div>
    <div className="mb-8 flex items-center ">
      ...
      <div onClick={()=>{navigate("/referrer/new")}} className="text-white bg-[--primary-dark] flex cursor-pointer ml-3 text-xl w-40 h-full p-1 items-center justify-around rounded-lg py-2">
